...
export class Mailsac<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    addresses = {
         ...
         * @secure
         */
        getAddress: (email: EmailString, params: RequestParams = {}) =>
         ...
         * @secure
         */
        createAddress: (email: EmailString, data?: UpdatePrivateAddressForwarding, params: RequestParams = {}) =>
            this.request<EmailAddress, ErrorResponseBody>({
                path: `/addresses/${email}`,
                method: "POST",
                body: data,
         ...
         * @secure
         */
        updateAddress: (email: EmailString, data: UpdatePrivateAddressForwarding, params: RequestParams = {}) =>
         ...
         * @secure
         */
        checkAvailability: (email: EmailString, params: RequestParams = {}) =>
            this.request<EmailAddressAvailability, any>({
    ...
    messages = {
         ...
         * @secure
         */
        countMessages: (email: EmailString, params: RequestParams = {}) =>
            this.request<
                {
                    /** @example 3 */
                    count?: number;
         ...
         * @secure
         */
        listStarredMessages: (params: RequestParams = {}) =>
         ...
         * @secure
         */
        getMessageMetadata: (email: EmailString, messageId: MessageId, params: RequestParams = {}) =>
            this.request<EmailMessage, ErrorResponseBody>({
         ...
         * @secure
         */
        deleteMessage: (email: EmailString, messageId: MessageId, params: RequestParams = {}) =>
            this.request<
                {
                    /** Unique Mailsac-generated identifier for an email message */
                    _id?: MessageId;
         ...
         * @secure
         */
        toggleMessageStar: (email: EmailString, messageId: MessageId, params: RequestParams = {}) =>
            this.request<EmailMessageShort, ErrorResponseBody>({
                path: `/addresses/${email}/messages/${messageId}/star`,
                method: "PUT",
                secure: true,
                format: "json",
                ...params,
         ...
         * @secure
         */
        addMessageLabel: (email: EmailString, messageId: MessageId, label: MessageLabel, params: RequestParams = {}) =>
            this.request<
                {
                    /** Unique Mailsac-generated identifier for an email message */
                    _id?: MessageId;
    ...
    attachments = {
         ...
         * @secure
         */
        listMessageAttachments: (email: EmailString, messageId: MessageId, params: RequestParams = {}) =>
            this.request<AttachmentMeta, ErrorResponseBody>({
        ...
        downloadAttachment: (
            ...
            this.request<File, ErrorResponseBody>({
         ...
         * @secure
         */
        countPublicAttachments: (md5Sum: Md5Sum, params: RequestParams = {}) =>
            this.request<
                {
                    n?: number;
                },
         ...
         * @secure
         */
        listMessagesForAttachment: (md5Sum: Md5Sum, params: RequestParams = {}) =>
            this.request<EmailMessage, ErrorResponseBody>({
         ...
         * @secure
         */
        downloadPublicAttachment: (md5Sum: Md5Sum, params: RequestParams = {}) =>
            this.request<void, ErrorResponseBody>({
                path: `/mailstats/common-attachments/${md5Sum}/download`,
                method: "GET",
                secure: true,
                ...params,
            }),
    ...
    messageStats = {
         ...
         * @secure
         */
        denylist: (params: RequestParams = {}) =>
            this.request<string[], ErrorResponseBody>({
                path: `/mailstats/blacklist`,
                method: "GET",
                secure: true,
                format: "json",
                ...params,
         ...
         * @secure
         */
        checkDenylist: (domainOrIp: string, params: RequestParams = {}) =>
            this.request<
                {
                    blacklisted?: boolean;
                },
    ...
    webhooks = {
         ...
         */
        doNotUseWebhookDocsOnly: (params: RequestParams = {}) =>
            this.request<void, any>({
                path: `/custom_webhooks`,
                method: "POST",
                ...params,
            }),
    };
